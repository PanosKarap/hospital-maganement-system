...
<%@ page import="karapravdasmatz.simpleClasses.Admin" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    <title>Λίστα Διαχειριστών</title>
    <style>
        body {
...
<body>
    <div class="container">
    	<h2>Λίστα Διαχειριστών</h2>
	    <div class="info-field">
		    <%
	        	List<Admin> admins = (List<Admin>) request.getAttribute("adminsList");
		    	if (!admins.isEmpty()) {
			        for (Admin admin : admins) {
			            out.print(admin.toString() + "<br/>");
			        }
			    } else out.print("Κανένας διαθέσιμος διαχειριστής");
			%>
		</div>		
